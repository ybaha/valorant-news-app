...
exports.agents = exports.agentIcons3 = exports.agentIcons2 = exports.agentIcons1 = exports.tagsColors = exports.tags = exports.maps = void 0;
exports.maps = ["Haven", "Fracture", "Ascent", "Icebox", "Split", "Bind"];
exports.tags = ["Bug", "Lineup", "News"];
exports.tagsColors = {
    Educational: "green",
    News: "blue",
    Gameplay: "purple",
...
exports.agentIcons1 = agentIcons.slice(0, agentIcons.length / 3);
exports.agentIcons2 = agentIcons.slice(agentIcons.length / 3, (agentIcons.length / 3) * 2);
exports.agentIcons3 = agentIcons.slice((agentIcons.length / 3) * 2, agentIcons.length);
exports.agents = agentIcons.map((e) => e.name);
